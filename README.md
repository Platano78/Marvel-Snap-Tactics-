...
Your collection and match history are stored in your browser's local storage. Use the Export feature in Settings to backup your data.
...
2. **Log matches right after playing** - Quick entry takes 2 seconds
3. **Use the calculator before snapping** - Know your odds
4. **Update collection after opening caches** - Keep it current
