...
- **key_facts.md** - Project configuration, endpoints, localStorage keys, design system values
- **issues.md** - Work log with PR/ticket IDs, descriptions, and URLs

### Memory-Aware Protocols

**Before proposing architectural changes:**
- Check `docs/project_notes/decisions.md` for existing decisions
- Verify the proposed approach doesn't conflict with past choices (e.g., ADR-001 mandates single HTML file)
...
- Check `docs/project_notes/key_facts.md` for localStorage keys, API endpoints, design system colors
- Prefer documented facts over assumptions

**When completing work on PRs/issues:**
- Log completed work in `docs/project_notes/issues.md`
- Include PR number, date, brief description, and URL
...
- **Include URLs** for PRs, documentation, external APIs
...
*Updated: January 2026 - Added Project Memory System*
